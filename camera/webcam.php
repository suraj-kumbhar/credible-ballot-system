...
<!--<script src="jpeg_camera/jpeg_camera_jpeg_camera_with_dependencies.min.js" type="text/javascript"></script>-->
<script>
    var options = {
  ...
  $('#take_snapshots').click(function(){
    ...
    snapshot.upload({api_url: "./camera/action.php"}).done(function(response) {
