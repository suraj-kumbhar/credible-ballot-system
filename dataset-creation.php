    ...
    <ul class="nospace group">
      ...
      <li class="one_third">
        <center>
          <div id="container">
            <form method="POST">
              <p><h1>Please press Start button to start face creating dataset process.</h1></p>
              <br>
            ...
            <?php
             ...
             exec("python C:\\xampp\\htdocs\\CBS\\face-recognition\\dataset_creator.py {$voterID}");
             shell_exec("python C:\\xampp\\htdocs\\CBS\\face-recognition\\trainer.py");
